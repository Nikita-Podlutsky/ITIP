...
public class Main {
    public static void main(String[] args) {
        // 1. Создаем нашу хэш-таблицу (карту)
        // В угловых скобках указываем: <Тип ключа, Тип значения>
        HashMap<Integer, Student> studentDatabase = new HashMap<>();

        // 2. ВСТАВКА студентов с помощью метода put()
        ...
        // 3. ПОИСК студента по номеру зачетки с помощью метода get()
        ...
        // 4. УДАЛЕНИЕ студента по ключу с помощью метода remove()
        ...
        // Проверяем, остался ли он в базе
